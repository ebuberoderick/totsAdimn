...
import { createPerference, fetchGroup } from '../services/authService'
                    ...
                    <div className="max-w-sm space-y-6 mx-auto rounded-lg p-4 bg-white">
                        ...
                        <div className="space-y-3">
                            ...
                            <div className="flex items-center gap-3 justify-center">
                                <div className="px-6 flex-grow py-2 text-center text-xs sm:text-sm rounded-md cursor-pointer bg-danger/80 hover:bg-danger text-white">Delete Preference</div>
                        ...
                        <div key={data?.name}>
                            <div className='border text-sm border-gray-200 space-y-2 rounded-lg p-2'>
                                <div className="flex items-center gap-4 justify-between">
                                    ...
                                    <div className="px-4 py-2 text-xs rounded-md cursor-pointer bg-gray-50 hover:bg-gray-100">Create Group</div>
                                </div>
